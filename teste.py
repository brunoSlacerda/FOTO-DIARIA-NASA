...
def exibirImagem():
    ...
    if url_imagem:
        ...
        if response_imagem.status_code == 200:
            ...
            # Verificar se o tipo de conteúdo é de imagem
            if 'image' in content_type:
                ...
                print(f"O conteudo forrnecido hoje pela API é um vídeo. Link para o vídeo: https://apod.nasa.gov/apod/astropix.html")
        else:
